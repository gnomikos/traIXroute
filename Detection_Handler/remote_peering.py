...
class remote_peering():
    ...
    def __init__(self):
        ...
        self.rules = {}
        # Maps IXP detection rule indexes from Rules.txt to number of hop in the hop window.
        self.indexes = {}
        ...
        # A temporary index used for remote peering detection for each hop window in a candidate IP path.
